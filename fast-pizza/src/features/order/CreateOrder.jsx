...
function CreateOrder() {
  ...
  const isLoadingPositionAddress = addressStatus === "loading";
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
          ...
          {!position.latitude && !position.longitude && 
            <span className="absolute right-[3px] top-[3px] z-50 md:right-[5px] md:top-[5px]">
              <Button 
                ...
                disabled={isLoadingPositionAddress}>get location</Button>
            </span>
          }
        </div>
        ...
        <div>
          ...
          <Button disabled={isSubmitting || isLoadingPositionAddress} type="primary">
